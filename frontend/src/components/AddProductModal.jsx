            ...
            <form onSubmit={addProduct} className="space-y-6">
                <div className="grid gap-6">
                    ...
                    <div className="relative">
                        <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none z-10"> {/*  left-0 text-base-content/50*/}
                    ...
                    <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                            <DollarSignIcon className="size-5 text-gray-500" />
                        </div>
                        <input
                        type="number"
                        min="0"
